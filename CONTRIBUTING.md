...
posted to #venue-dev on irc.freenode.net).
...
Copyright (c) 2017-2018 The Venue Project.
...
The "Venue Maintainer Team" is defined in this document as the following users:
- fluffypony
- xcashmooo
- hyc
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to Venue code or Venue's dependency code or Venue's potential/future dependency code or research which successfully implements Venue.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Venue Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Venue Maintainer Team.
